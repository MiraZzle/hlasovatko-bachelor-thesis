<script lang="ts">
	/**
	 * @file Component for displaying a scale rating activity.
	 * It shows a scale with defined min and max values, and optional labels.
	 */
	...
	// Generate an array of scale points based on the min and max values
